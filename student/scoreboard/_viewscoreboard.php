...
if ($connection)
{
	...
	$queryString = 'SELECT Name,EmailId,Department,Status,Memory,Time FROM Scoreboard WHERE questionId=:qid';
	$bindings = array(
			'qid' => $_GET['id']
	);
				...
				<tbody>
					...
					for ($index = 0 ; $index<$numberOfRows; $index++)
					{
						echo "<tr>";
							...
							echo "<td>".$queryResult[$index]["Name"]."</td>";
							echo "<td>".$queryResult[$index]["Department"]."</td>";
