...
<head>
    ...
    <link rel="stylesheet" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/assets/css/main.css">
    <script>
...
<div class="container-fluid">
    <div class="row">
        <section class="col-sm-3 col-md-2 sidebar"><ul class="nav nav-sidebar">
                ...
                <li ><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/student/submissions/">MySubmissions</a></li>
